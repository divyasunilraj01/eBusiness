            ...
            <div class="row checkout">
                <div class="col-xs-10 col-xs-offset-1 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                    <div class="alert alert-info" role="alert">
                        <b>${order.client.name}</b>, Thank You For Your Order!<br><br>
                        Sales Person Connect Soon!!!<br><br>
                        Order Number <b>${order.number}</b><br><br>
                        See You Soon<br><br>
                        Contact Us Mobile:<br><br>
                        +012 438 675 12<br><br>
                       Great Job!! <b>A1 Coffee</b>.<br>
                    </div>
                </div>
