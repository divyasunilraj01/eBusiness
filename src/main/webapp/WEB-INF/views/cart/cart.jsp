...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <meta name="description" content="Cart-Selected Item"/>
        <meta name="keywords" content="Proceed"/>
            ...
            <div class="row cart">
                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                    <div class="row section-name text-shadow color-brown">
                        <b>
                            <span class="color-brown">Cart</span>
                            <c:if test="${sale_positions_length eq 0}">
                                <span class="color-green"> Empty!</span>
                            </c:if>
                        </b>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <form action="checkout" method="post">
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
                                <input class="phone input" type="text" name="user_phone" placeholder=" Enter Phone Number"
                                       required>
                            </div>
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
                            ...
                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-xl-2 input-padding text-center">
                                <input type="submit" class="btn btn-success" value="Place Order" width="80px">
                            </div>
                        </form>
                    </div>
                    <div class="row">
