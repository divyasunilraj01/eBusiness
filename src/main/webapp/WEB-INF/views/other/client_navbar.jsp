            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand text-shadow">
                    <a href="<c:url value="/home"/>">
                        ...
                        <img src="<c:url value="/resources/img/favicon.png"/>" class="nav-label" alt="A1Coffee">
                    </a>
                </div>
            </div>
                ...
                <div id="menu-product">
                    <ul class="nav navbar-nav">
                        ...
                        <li id="nav-delivery" class="hidden-sm">
                            <a href="<c:url value="/home#delivery"/>">Delivery</a>
                        </li>
                        <li id="nav-payments" class="hidden-sm">
                            <a href="<c:url value="/home#payments"/>">Payments</a>
                        </li>
                        <li id="nav-contacts" class="hidden-sm">
                            <a href="<c:url value="/home#contacts"/>">Contact Us</a>
                        </li>
                    </ul>
