...
<compress:html removeIntertagSpaces="true">
    ...
    <head>
        ...
        <meta name="author" content="https://www.linkedin.com/in/divya-sunilraj-3bb66b124">
                ...
                <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1 col-xl-10 col-xl-offset-1">
                    <div class="row section-name text-shadow">
                        <b>
                            ...
                            <c:if test="${orders_length eq 0}"><span class="color-red"> - List is Empty!</span></c:if>
                        </b>
                    </div>
                </div>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${(order.status eq status_new) or (order.manager eq auth_user)}">
                                            <a href="<c:url value="/managers/order/edit/${order.id}"/>"
                                               title="Edit orders ${order.number}">
